...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7609b469d8b406504438efa83ace8847762a2dceb16a84cdcd0f3500fb8cf404.js',function(){input.required=false;search();});}
