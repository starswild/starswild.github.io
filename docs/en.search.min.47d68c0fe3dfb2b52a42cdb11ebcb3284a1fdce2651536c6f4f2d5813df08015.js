...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7460e9d2e0a3850e93992dde46939bc02dd958ea792728c057b7df47fcbdaed3.js',function(){input.required=false;search();});}
