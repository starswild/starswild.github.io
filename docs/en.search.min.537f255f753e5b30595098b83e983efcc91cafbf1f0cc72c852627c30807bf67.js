...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c161e9527ff7d9e68166996cd5854c62d614f58d75d2ce93bb8e72e55add64fc.js',function(){input.required=false;search();});}
