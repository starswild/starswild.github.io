...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4f62cd61c8697b64a0a505ef6513f2c6c06297a15307d6ca4ecc9af9e38a6908.js',function(){input.required=false;search();});}
