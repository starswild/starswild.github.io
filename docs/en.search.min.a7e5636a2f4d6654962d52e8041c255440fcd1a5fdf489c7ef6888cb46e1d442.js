...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bc8623ad7ed6d36eb2d60a2b967643790fd082b242c164650205b46955e3cb3c.js',function(){input.required=false;search();});}
