...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f19a3751b165bd97f36eed1d0072323ab39b45e59d1cd75dddc501224ba6deb2.js',function(){input.required=false;search();});}
